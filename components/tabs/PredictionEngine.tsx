...
import { zionbetPeMarketHref } from "@/lib/zionbet-pe-routes";
                  ...
                  <div style={{ marginBottom: "24px" }}>
                      <>
                        ...
                        >
                              ...
                              {zionbetFilteredDeepbookMarkets.map((m) => {
                                ...
                                return (
                                  <ZionBetMarketCardItem
                                    ...
                                    isZionCard={false}
                                    onOpen={() => router.push(zionbetPeMarketHref(m.id, betTab))}
                          ...
                          <>
                            {betTab === "civilization" && zionbetFilteredZionMarkets.length > 0 ? (
                              <div style={{ marginBottom: "16px" }}>
                                ...
                                <div className={`zionBetPmCardGrid${isMobile ? " zionBetPmCardGrid--mobile" : ""}`}>
                                  {zionbetFilteredZionMarkets.map((market) => {
                                    ...
                                    return (
                                      <ZionBetMarketCardItem
                                        ...
                                        onOpen={() => router.push(zionbetPeMarketHref(marketApi.id, betTab))}
                                        onBetYes={(e) => {
                                          e.stopPropagation();
                            ...
                            {zionbetDisplayedMarkets.length === 0 ? (
                              betTab === "civilization" && zionbetFilteredZionMarkets.length > 0 ? null : (
                                <p style={{ fontSize: "0.78rem", color: "#8b9ab1", margin: "12px 0" }}>
                                  No active markets in this category
                                </p>
                              )
